...
interface ChemicalTableProps {
  ...
  totalPages: number;
  onPageChange: (page: number) => void;
  mode?: "home" | "management"; // default "home"
  onDelete?: (chemicalId: string) => void;
  userRole?: string;
}
...
export function ChemicalTable({
  ...
  return (
    <>
      <div className="rounded-md border">
        <div className="w-full overflow-x-auto">
          <Table className="table-auto min-w-[900px] [&_th]:px-4 [&_td]:px-4">
            <TableHeader>
              <TableRow className="bg-blue-50 hover:bg-blue-100">
                ...
                {canAction && <TableHead>Aksi</TableHead>}
              </TableRow>
            </TableHeader>
            <TableBody>
              {chemicals.map((chemical, index) => (
                <TableRow key={chemical.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center">
                      <span className="text-gray-400 h-7 w-7">-</span>
                    </div>
                  </TableCell>
                  {canAction && (
                    <TableCell>
